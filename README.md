...
Repository of work samples from professional experience in Investment Research at [Lumida Wealth Management](https://www.lumida.com/).
...
Conducted preliminary analysis, initial coverage, and ongoing due diligence for tokens, protocols, and themes for client requests and internal needs. Format include PDFs and interactive webapp reports covering L0s, L1s, L2s, DeFi, Decentralized Storage, Oracles, and Gaming.
...
Conducted deep dive tokennomics research and built DeFi models in shared Jupyter notebooks.

Example of single token impermanent loss on simple AMM:
...
Built dashboards with Dash and Plotly to track macro indicators, strategy performance, and token specific analytics for internal and clients, such as
- Cap-weighted indexes with overbought and oversold tokens
- Multicoin interactive charts e.g. correlation, drawdowns
- Performance trackers for various strategies
- L2 Scaling Solutions On-chain Activity (Polygon, Arbitrum, Optimism)

Example provided above was a dev environment where I tested charts and performance prior to moving to test and prod.

Snapshot of example dashboard:
...
Tested crypto portfolio strategies that could be executed off-chain through TradFi compliant institutions, focusing on mega-cap tokens in particular BTC.
